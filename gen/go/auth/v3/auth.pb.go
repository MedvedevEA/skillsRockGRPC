...
func (x *LogoutRequest) GetLogin() string {
	if x != nil {
		return x.Login
	}
	return ""
...
func (x *ValidateTokenRequest) GetTokenId() string {
	if x != nil {
		return x.TokenId
	}
	return ""
...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\frefreshToken\x18\x02 \x01(\tR\frefreshToken\"E\n" +
	...
	"\x14ValidateTokenRequest\x12\x18\n" +
	"\atokenId\x18\x01 \x01(\tR\atokenId\"\x17\n" +
...
var file_proto_auth_proto_goTypes = []any{
	(*UnregisterRequest)(nil),      // 0: auth.UnregisterRequest
	(*UnregisterResponse)(nil),     // 1: auth.UnregisterResponse
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	0,  // 1: auth.AuthService.Unregister:input_type -> auth.UnregisterRequest
	...
	1,  // 9: auth.AuthService.Unregister:output_type -> auth.UnregisterResponse
